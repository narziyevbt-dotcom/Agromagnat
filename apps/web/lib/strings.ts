...
export const t = {
  ...
  auth: {
    ...
    telegramFree: 'Eng tez yo‘l — SMS kutish shart emas',
    telegramWaiting: 'Telegram kutilmoqda…',
    telegramHint:
      'Telegramda “📱 Raqamimni yuborish” tugmasini bosing. Shu sahifani yopmang — kirish o‘zi yakunlanadi.',
    telegramOpenAgain: 'Telegram ochilmadimi? Shu yerni bosing',
    telegramExpired: 'Kirish so‘rovi eskirdi. Qaytadan urinib ko‘ring',
    telegramFailed: "Telegram orqali kirishni boshlab bo'lmadi",
